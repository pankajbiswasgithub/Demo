...
//Write your logic here
 Map<String, Double> averageSalaryByLocation = employees.parallelStream()
       .collect(Collectors.groupingBy(e->getGroupingByKey(e), Collectors.averagingDouble(e->e.getSalary())));

for (Map.Entry<String, Double> entry : averageSalaryByLocation.entrySet()){
    System.out.println(entry.getKey()+" --> "+entry.getValue());
};
}

private String getGroupingByKey(Employee e){
return e.getOfficeLocation()+" --> "+e.getDesignation();
}
}
